...
class CreateEntryFieldHistoryTotpSyncJobTest extends IntegrationTestCase
{
    /**
    ...
    public function test_it_should_create_an_entry_field_history_password(): void
    {
        ...
        $this->assertInstanceof(EntryFieldHistoryTotp::class, $entryFieldHistory);
        ...
        new CreateEntryFieldHistoryTotpSyncJob($payload)->handle();
        ...
        $this->assertDatabaseHas(EntryFieldHistoryFixture::getTableName(), [
            ...
            EntryFieldHistoryFixture::TYPE => EntryFieldTypeEnum::TOTP->value,
        ]);
    }
    ...
    public function test_it_should_dispatch_an_event(): void
    {
        ...
        $testEventHandler = new TestEventHandler(
            eventNames: [EntryFieldHistoryTotpCreatedEvent::class, EntryFieldHistoryCreatedGeneralEvent::class],
        );
