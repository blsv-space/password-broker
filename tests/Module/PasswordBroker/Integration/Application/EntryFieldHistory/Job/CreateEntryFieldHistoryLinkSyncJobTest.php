...
class CreateEntryFieldHistoryLinkSyncJobTest extends IntegrationTestCase
{
    /**
     * @throws PersistenceException
     * @throws RsaDomainServiceException
     */
    public function test_it_should_create_an_entry_field_history_link(): void
    {
        ...
        $this->assertInstanceof(EntryFieldHistoryLink::class, $entryFieldHistory);
        ...
        new CreateEntryFieldHistoryLinkSyncJob($payload)->handle();
        ...
        $this->assertDatabaseHas(EntryFieldHistoryFixture::getTableName(), [
            ...
            EntryFieldHistoryFixture::TYPE => EntryFieldTypeEnum::LINK->value,
        ]);
    }
    ...
    public function test_it_should_dispatch_an_event(): void
    {
        ...
        $testEventHandler = new TestEventHandler(
            eventNames: [EntryFieldHistoryLinkCreatedEvent::class, EntryFieldHistoryCreatedGeneralEvent::class],
        );
