...
class UpdateEntryFieldPasswordSyncJobTest extends IntegrationTestCase
{
    /**
     * @throws PersistenceException
     * @throws RsaDomainServiceException
     */
    public function test_it_should_update_an_entry_field_password(): void
    {
        ...
        new UpdateEntryFieldPasswordSyncJob($payload)->handle();
    ...
    public function test_it_should_dispatch_an_event(): void
    {
        ...
        $testEventHandler = new TestEventHandler(
            eventNames: [EntryFieldPasswordUpdatedEvent::class, EntryFieldUpdatedGeneralEvent::class],
        );
