...
final class EntryFieldFile extends AbstractEntryField
{
    public function __construct(
        ...
        UserId $createdBy,
        ?UserId $updatedBy,
        public EntryFieldFileName $fileName,
        public EntryFieldFileMime $fileMime,
        public EntryFieldFileSize $fileSize,
    ) {
        parent::__construct(
            id: $id,
            entryId: $entryId,
            type: EntryFieldType::fromRaw(EntryFieldTypeEnum::FILE),
            title: $title,
