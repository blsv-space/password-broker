...
final class EntryFieldHistoryTotp extends AbstractEntryFieldHistory
{
    public function __construct(
        ...
        UserId $createdBy,
        CreatedAt $createdAt,
        public readonly EntryFieldTotpHashAlgorithm $totpHashAlgorithm,
        public readonly EntryFieldTotpTimeout       $totpTimeout,
    ) {
        parent::__construct(
            id: $id,
            entryFieldId: $entryFieldId,
