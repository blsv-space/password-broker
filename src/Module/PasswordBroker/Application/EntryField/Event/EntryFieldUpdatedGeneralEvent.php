...
final readonly class EntryFieldUpdatedGeneralEvent extends AbstractPasswordBrokerEvent implements EventInterface
{
    ...
    {
        return parent::getEventName() . '.entryField.general.updated';
    }
