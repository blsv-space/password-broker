...
final readonly class EntryFieldCreatedGeneralEvent extends AbstractPasswordBrokerEvent implements EventInterface
{
    ...
    {
        return parent::getEventName() . '.entryField.general.created';
    }
