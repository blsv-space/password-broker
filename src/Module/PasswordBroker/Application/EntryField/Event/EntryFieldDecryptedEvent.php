...
final readonly class EntryFieldDecryptedEvent extends AbstractPasswordBrokerEvent implements EventInterface
{
    ...
    {
        return parent::getEventName() . '.entryField.decrypted';
    }
