...
final readonly class EntryFieldHistoryCreatedGeneralEvent extends AbstractPasswordBrokerEvent implements EventInterface
{
    ...
    {
        return parent::getEventName() . '.entryFieldHistory.general.created';
    }
