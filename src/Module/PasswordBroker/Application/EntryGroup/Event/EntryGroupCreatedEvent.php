...
final readonly class EntryGroupCreatedEvent extends AbstractPasswordBrokerEvent implements EventInterface
{
    ...
    {
        return parent::getEventName() . '.entryGroup.created';
    }
