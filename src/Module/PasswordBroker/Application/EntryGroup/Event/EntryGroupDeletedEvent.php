...
final readonly class EntryGroupDeletedEvent extends AbstractPasswordBrokerEvent implements EventInterface
{
    ...
    {
        return parent::getEventName() . '.entryGroup.deleted';
    }
