...
final readonly class EntryGroupUserAesEncryptedPasswordChangedEvent extends AbstractPasswordBrokerEvent implements EventInterface
{
    ...
    {
        return parent::getEventName() . '.entryGroupUser.roleChanged';
    }
