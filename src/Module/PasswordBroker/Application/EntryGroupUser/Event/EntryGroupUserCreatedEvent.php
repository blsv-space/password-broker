...
final readonly class EntryGroupUserCreatedEvent extends AbstractPasswordBrokerEvent implements EventInterface
{
    ...
    {
        return parent::getEventName() . '.entryGroupUser.created';
    }
